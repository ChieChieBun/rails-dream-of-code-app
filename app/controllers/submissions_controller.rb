class SubmissionsController < ApplicationController
  ...
  def new
    ...
    @lessons = Lesson.find(params[:course_id]) # TODO: What set of lessons should be listed in the dropdown?
  end
  ...
  def create
    ...
    if @submission.save
      ...
      @lessons = Lesson.find(params[:course_id]) # TODO: Set this up just as in the new action
      render :new
    end
  end
